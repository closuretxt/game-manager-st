...
const CHAR_REFINE_PROMPT_HEADER = [
    ...
    "- SCALING RESOURCES: when progression is active, at most 1-2 core resources (e.g. Health, Mana) may keep a max formula with Level or attribute names (e.g. \"100+(Level*10)\") — everything else stays a plain number. Without progression, never use formulas.",
