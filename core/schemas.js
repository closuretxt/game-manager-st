...
export const GM_SCHEMA = {
    resource: {
        ...
        container: "resources",
        description: "Tracked value with a custom range (e.g. Health 1-100, Ammo 1-36). Max accepts a formula like 100+(Level*10).",
        fields: [
            ...
            { key: "max", label: "Max (num or formula)", type: "text", default: "100" },
