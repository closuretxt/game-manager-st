// LEGACY — swap-based connection profile switching (advanced option).
// Swaps the user's ACTIVE SillyTavern connection profile, runs, and swaps
// back. Only used when "Legacy connection profile swapping" is enabled in the
// settings' Advanced section. The default path is per-request profiles via
// ConnectionManagerRequestService — see util/connectionService.js.

import { SlashCommandParser } from "../../../../slash-commands/SlashCommandParser.js";
import { event_types, online_status, eventSource } from "../../../../../script.js";

const LOG_PREFIX = "[Game Manager Profile Swapper]";
...
export async function swapProfile(targetProfileName, currentProfileName) {
    ...
    try {
        ...
        await new Promise(resolve => setTimeout(resolve, 1500)); // SillyTavern can be funny sometimes, APIs like OpenAi and deepseek load TWICE so a delay is needed regardless.
